...
public class RegistroCaixaTest {
    ...
    public void objetoNaoPodeModificarLinha() {
        Assert.assertEquals(RegistroCaixaTest.LINHA_VALIDA, new RegistroCaixa(RegistroCaixaTest.LINHA_VALIDA).getLinha());
    }
    ...
    @Test
    public void dataOcorrencia000000() {
        Assert.assertNull(new RegistroCaixa("102123456780001231234560000000123                             82105708253      000                        1421000000                              010113000000000975000113776000000000000100663101210113              0000000000000000000000000000000000000000000000009750000000000000000000000000001210113                         0000000000000000000000000                                             000002").getDataOcorrencia());
    }
    ...
    @Test
    public void dataVencimento000000() {
        Assert.assertNull(new RegistroCaixa("102123456780001231234560000000123                             82105708253      000                        1421010113                              000000000000000975000113776000000000000100663101210113              0000000000000000000000000000000000000000000000009750000000000000000000000000001210113                         0000000000000000000000000                                             000002").getVencimento());
    }
    ...
    @Test
    public void dataDebitoTarifa000000() {
        Assert.assertNull(new RegistroCaixa("102123456780001231234560000000123                             82105708253      000                        1421010113                              010113000000000975000113776000000000000100663101000000              0000000000000000000000000000000000000000000000009750000000000000000000000000001210113                         0000000000000000000000000                                             000002").getDataDebitoTarifa());
    }
    ...
    @Test
    public void dataCredito000000() {
        Assert.assertNull(new RegistroCaixa("102123456780001231234560000000123                             82105708253      000                        1421010113                              010113000000000975000113776000000000000100663101210113              0000000000000000000000000000000000000000000000009750000000000000000000000000001000000                         0000000000000000000000000                                             000002").getDataCredito());
    }
