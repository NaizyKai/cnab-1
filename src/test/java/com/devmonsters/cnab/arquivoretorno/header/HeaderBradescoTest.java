...
public class HeaderBradescoTest {
    ...
    public void objetoNaoPodeModificarLinha() {
        Assert.assertEquals(HeaderBradescoTest.LINHA_VALIDA, new HeaderBradesco(HeaderBradescoTest.LINHA_VALIDA).getLinha());
    }
    ...
    @Test
    public void dataGravacao000000() {
        Assert.assertNull(new HeaderBradesco("02RETORNO01COBRANCA       00000000000001111333ABCD DISTRIBUIDORA LTDA       237BRADESCO       0000000160000000805                                                                                                                                                                                                                                                                          180213         000001").getDataGravacao());
    }
    ...
    public void dataCredito000000() {
        Assert.assertNull(new HeaderBradesco("02RETORNO01COBRANCA       00000000000001111333ABCD DISTRIBUIDORA LTDA       237BRADESCO       1502130160000000805                                                                                                                                                                                                                                                                          000000         000001").getDataCredito());
    }
